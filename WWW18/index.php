...
<html>
	...
	<table class="gornefunkcje"> 
		...
		<form method="post"> 
			&nbsp;&nbsp;&nbsp;
			<input class="gornefunkcje" type="button" onclick="IntoSklep()" value="Sklep">
		</form>
		...
		<?php
			...
			} else if ((basename($_SERVER['PHP_SELF']) != 'adminsite.php') && (basename($_SERVER['PHP_SELF']) != 'sklep.php')){
		...
		if ((basename($_SERVER['PHP_SELF']) != 'adminsite.php') && (basename($_SERVER['PHP_SELF']) != 'sklep.php')){
            $nr_indeksu = '164435';
            $nrGrupy = '4ISI';
